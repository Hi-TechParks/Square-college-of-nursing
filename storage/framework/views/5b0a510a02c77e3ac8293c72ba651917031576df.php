      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <img src="/uploads/images/applicant/<?php echo e($application->APPLICANT_PHOTO_PATH); ?>" class="card-img-top" alt="Applicant">
              <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Running Project\SCN\resources\views/admin/application/application_view.blade.php ENDPATH**/ ?>