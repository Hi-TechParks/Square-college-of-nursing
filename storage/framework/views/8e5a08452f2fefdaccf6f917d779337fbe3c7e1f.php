      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <img src="<?php echo e(asset('/uploads/images/profile/'.$member->PROFILE_IMAGE_PATH)); ?>" class="card-img-top" alt="Event">
              <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SCN-15-06-19\SCN\resources\views/admin/member/member_view.blade.php ENDPATH**/ ?>