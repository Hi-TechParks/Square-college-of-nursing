<?php $__env->startSection('content'); ?>
    ...
    <!--== Page Header Start ==-->
    <section class="section mt-50" id="page-header" style="background-image:url('<?php echo e(asset('/uploads/images/event/'.$event->IMAGE_PATH)); ?>')">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SCN-15-06-19\SCN\resources\views/event-details.blade.php ENDPATH**/ ?>