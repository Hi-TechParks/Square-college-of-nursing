        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><?php echo e($message->name); ?></h5>
                <p class="card-text"><?php echo $message->MESSAGE_CONTENT; ?></p>
              </div>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Designation: <?php echo e($message->DESIGNATION_NAME); ?></li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SCN-15-06-19\SCN\resources\views/admin/message/message_view.blade.php ENDPATH**/ ?>