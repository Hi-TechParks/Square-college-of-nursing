        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <a href="<?php echo e(URL('/admin/gallery/create')); ?>" class="btn btn-primary">Refresh</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                <!--== Data Form Start ==-->
                <form action="<?php echo e(url('/admin/gallery/store')); ?>" method="post" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      ...
                      <?php if($errors->has('show_home')): ?>
                          <span class="error_msg">
                            <?php echo e($errors->first('show_home')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SCN-15-06-19\SCN\resources\views/admin/gallery/gallery_create.blade.php ENDPATH**/ ?>