  	  	  ...
  	  	  <div class="col-lg-3 col-md-6 col-sm-12">
    		    <div class="card">
    		      <div class="card-body">
    		        <div class="person-box-header">
    		          <div class="person-box-image">
    		          	<img src="/uploads/images/profile/<?php echo e($c_message->PROFILE_IMAGE_PATH); ?>" class="img-fluid mx-auto d-block">
    		          </div>
                  ...
                  <?php if(strlen($c_message->MESSAGE_CONTENT) > 200): ?>
                    <a class="read_more" href="/message/<?php echo e($c_message->MESSAGE_ID); ?>"> Read More</a>
                  <?php endif; ?>
    		        </div>
    		      </div>
    		    </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="card">
              <div class="card-body">
                <div class="person-box-header">
                  <div class="person-box-image">
                    <img src="/uploads/images/profile/<?php echo e($md_message->PROFILE_IMAGE_PATH); ?>" class="img-fluid mx-auto d-block">
                  </div>
                ...
                <div class="person-box-footer">
                  ...
                  <?php if(strlen($md_message->MESSAGE_CONTENT) > 200): ?>
                    <a class="read_more" href="/message/<?php echo e($md_message->MESSAGE_ID); ?>"> Read More</a>
                  <?php endif; ?>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="card">
              <div class="card-body">
                <div class="person-box-header">
                  <div class="person-box-image">
                    <img src="/uploads/images/profile/<?php echo e($gb_message->PROFILE_IMAGE_PATH); ?>" class="img-fluid mx-auto d-block">
                  </div>
                ...
                <div class="person-box-footer">
                  ...
                  <?php if(strlen($gb_message->MESSAGE_CONTENT) > 200): ?>
                    <a class="read_more" href="/message/<?php echo e($gb_message->MESSAGE_ID); ?>"> Read More</a>
                  <?php endif; ?>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="card">
              <div class="card-body">
                <div class="person-box-header">
                  <div class="person-box-image">
                    <img src="/uploads/images/profile/<?php echo e($p_message->PROFILE_IMAGE_PATH); ?>" class="img-fluid mx-auto d-block">
                  </div>
                ...
                <div class="person-box-footer">
                  ...
                  <?php if(strlen($p_message->MESSAGE_CONTENT) > 200): ?>
                    <a class="read_more" href="/message/<?php echo e($p_message->MESSAGE_ID); ?>"> Read More</a>
                  <?php endif; ?>
                </div>
              </div>
            </div>
  	  ...
  	  <div class="container">
          ...
          <div class="col-sm-12 col-md-4">
            <div class="admission-image">
              <img src="assets/img/admissions.png" alt="admission">

              <div class="admisson-button">
                <a href="/admission">ADMISSION IN NURSING</a>
              </div>
            </div>
          </div>
              ...
              <div class="event-notice-box-body">
                ...
                <div class="single-notice-box">
                  ...
                  <div class="single-notice-right">
                    ...
                    <a href="/notice/single/<?php echo e($notice->NOTICE_ID); ?>">View More</a>
                  </div>
                </div>
                <!--== Single Notice Box ==-->
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="/notice" class="view_all">View All</a>
    ...
    <section class="section" id="event-page">
      <div class="container">
            ...
            <div class="event-page-single-box">
              <div class="event-page-single-box-left">
                <div class="event-page-single-box-image">
                  <img src="/uploads/images/event/<?php echo e($event->IMAGE_PATH); ?>" class="img-fluid mx-auto d-block" alt="campus tour" />
                </div>
              </div>
              <div class="event-page-single-box-right">
                ...
                <div class="event-page-single-box-footer">
                  <a href="/event/single/<?php echo e($event->EVENT_ID); ?>" class="read_more">View Details</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-xs-12">
            <a href="/event" class="view_all" style="color: #fff;">View All</a>
          </div>
        </div>
        ...
        <!--== Section Title Area ==-->
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div class="single-photo-gallery">
              <img src="/uploads/images/gallery/<?php echo e($image->IMAGE_FILE_PATH); ?>" class="img-fluid mx-auto d-block" alt="Photo">
              <a data-fancybox="gallery" href="/uploads/images/gallery/<?php echo e($image->IMAGE_FILE_PATH); ?>">
              ...
              <div class="card-body">
                <div class="testimonial-box-header">
                  ...
                  <?php if(strlen($testimonial->TESTIMONIAL_CONTENT) > 200): ?>
                    <a class="read_more" href="/testimonial/<?php echo e($testimonial->TESTIMONIAL_ID); ?>"> Read More</a>
                  <?php endif; ?>
                </div>
                <div class="testimonial-box-footer">
                  <div class="testimonial-box-image">
                    <img src="/uploads/images/reviewer/<?php echo e($testimonial->IMAGE_PATH); ?>" class="img-fluid mx-auto d-block">
                  </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Running Project\SCN\resources\views/index.blade.php ENDPATH**/ ?>