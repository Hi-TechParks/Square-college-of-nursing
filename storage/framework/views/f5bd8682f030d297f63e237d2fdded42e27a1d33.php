      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title"><?php echo e($event_type->TYPE_NAME); ?></h5>
                <p class="card-text"><?php echo $event_type->TYPE_DESC; ?></p>
              </div>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Short Code: <?php echo e($event_type->SHORT_CODE); ?></li>
                <li class="list-group-item">Color: <div style="float: right; width: 100px; height: 30px; background: <?php echo e($event_type->COLOR_CODE); ?>"></div></li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SCN-15-06-19\SCN\resources\views/admin/event_type/event_type_view.blade.php ENDPATH**/ ?>