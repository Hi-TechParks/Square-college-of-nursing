      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <img src="<?php echo e(asset('/uploads/images/event/'.$event->IMAGE_PATH)); ?>" class="card-img-top" alt="Event">
              <div class="card-body">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Event Time: <?php echo e($event->EVENT_TIME); ?></li>
                <li class="list-group-item">Location: <?php echo e($event->EVENT_LOCATION); ?></li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SCN-15-06-19\SCN\resources\views/admin/event/event_view.blade.php ENDPATH**/ ?>