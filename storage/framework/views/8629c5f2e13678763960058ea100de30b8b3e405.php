      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <img src="<?php echo e(asset('/uploads/images/student/'.$application->APPLICANT_PHOTO_PATH)); ?>" class="card-img-top" alt="Applicant">
              <div class="card-body">
                <h5 class="card-title"><?php echo e($application->STUDENT_NAME); ?></h5>
              </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SCN-15-06-19\SCN\resources\views/admin/student/student_view.blade.php ENDPATH**/ ?>