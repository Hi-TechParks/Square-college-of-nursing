        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <a href="<?php echo e(url('/admin/procourse/edit/'.$procourse->PROGRAM_COURSE_ID)); ?>" class="btn btn-primary">Refresh</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                <!--== Data Form Start ==-->
                <form action="<?php echo e(url('/admin/procourse/update/'.$procourse->PROGRAM_COURSE_ID)); ?>"" method="post" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="course_name" required>
                        ...
                        <option value="<?php echo e($course->COURSE_ID); ?>" <?php if( $procourse->COURSE_ID == $course->COURSE_ID ): ?> selected <?php endif; ?>>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="program_name" required>
                        ...
                        <option value="<?php echo e($program->PROGRAM_ID); ?>" <?php if( $procourse->PROGRAM_ID == $program->PROGRAM_ID ): ?> selected <?php endif; ?>>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="session_name" required>
                        ...
                        <option value="<?php echo e($session->SESSION_ID); ?>" <?php if( $procourse->SESSION_ID == $session->SESSION_ID ): ?> selected <?php endif; ?>>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="year_name" required>
                        ...
                        <option value="<?php echo e($year->YEAR_ID); ?>" <?php if( $procourse->YEAR_ID == $year->YEAR_ID ): ?> selected <?php endif; ?>>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SCN-15-06-19\SCN\resources\views/admin/program_course/program_course_edit.blade.php ENDPATH**/ ?>