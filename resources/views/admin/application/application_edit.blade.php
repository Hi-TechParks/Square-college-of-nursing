        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <a href="{{ url('/admin/application/edit/'.$application->ADMISSION_APPLICATION_FORM_ID) }}" class="btn btn-primary">Refresh</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                <!--== Data Form Start ==-->
                <form action="{{ url('/admin/application/update/'.$application->ADMISSION_APPLICATION_FORM_ID) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="applicant_name" value="{{ $application->APPLICANT_NAME }}" placeholder="Applicant Name">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="father_profession" value="{{ $application->FATHER_PROFESSION }}" placeholder="Father Profession">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="mother_profession" value="{{ $application->MOTHER_PROFESSION }}" placeholder="Mother Profession">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="guardian_name_1" value="{{ $application->LEGAL_GUARDIAN_NAME1 }}" placeholder="Guardian Name">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <textarea class="form-control" name="guardian_address_1" placeholder="Guardian Address">{{ $application->LEGAL_GUARDIAN_CONTACT_ADDRESS1 }}</textarea>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="guardian_phone_1" value="{{ $application->LEGAL_GUARDIAN_CONTACT_NO1 }}" placeholder="Guardian Phone">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="guardian_relation_1" value="{{ $application->LEGAL_GUARDIAN_RELATION1 }}" placeholder="Guardian Relation">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Guardian Name</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="guardian_name_2" value="{{ $application->LEGAL_GUARDIAN_NAME2 }}" placeholder="Guardian Name">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Guardian Address</label>
                    <div class="col-sm-8">
                      <textarea class="form-control" name="guardian_address_2" placeholder="Guardian Address">{{ $application->LEGAL_GUARDIAN_CONTACT_ADDRESS2 }}</textarea>
                  ...
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Guardian Phone</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="guardian_phone_2" value="{{ $application->LEGAL_GUARDIAN_CONTACT_NO2 }}" placeholder="Guardian Phone">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Guardian Relation</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="guardian_relation_2" value="{{ $application->LEGAL_GUARDIAN_RELATION2 }}" placeholder="Guardian Relation">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="declaration_title">
                        ...
                        <option value="{{ $declaration->ADMISSION_APP_FORM_DECLARATION_ID }}" @if( $declaration->ADMISSION_APP_FORM_DECLARATION_ID == $application->ADMISSION_APP_FORM_DECLARATION_ID ) selected @endif>{{ $declaration->DECLARATION_TITLE }}</option>
                        @endforeach
                      </select>
