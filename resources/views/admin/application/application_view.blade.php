      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <img src="{{ asset('/uploads/images/applicant/'.$application->APPLICANT_PHOTO_PATH) }}" class="card-img-top" alt="Applicant">
              <div class="card-body">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Father Profession: {{ $application->FATHER_PROFESSION }}</li>
                <li class="list-group-item">Mother Name: {{ $application->MOTHER_NAME }}</li>
                <li class="list-group-item">Mother Profession: {{ $application->MOTHER_PROFESSION }}</li>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <li class="list-group-item">Guardian Name: {{ $application->LEGAL_GUARDIAN_NAME1 }}</li>
                    <li class="list-group-item">Guardian Address: {{ $application->LEGAL_GUARDIAN_CONTACT_ADDRESS1 }}</li>
                    <li class="list-group-item">Guardian Phone: {{ $application->LEGAL_GUARDIAN_CONTACT_NO1 }}</li>
                    <li class="list-group-item">Guardian Relation: {{ $application->LEGAL_GUARDIAN_RELATION1 }}</li>
                    </fieldset>
                  </div>
                  <div class="col-sm-6">
                    <fieldset>
                      <legend>Guardian 1:</legend>
                    <li class="list-group-item">Guardian Name: {{ $application->LEGAL_GUARDIAN_NAME2 }}</li>
                    <li class="list-group-item">Guardian Address: {{ $application->LEGAL_GUARDIAN_CONTACT_ADDRESS2 }}</li>
                    <li class="list-group-item">Guardian Phone: {{ $application->LEGAL_GUARDIAN_CONTACT_NO2 }}</li>
                    <li class="list-group-item">Guardian Relation: {{ $application->LEGAL_GUARDIAN_RELATION2 }}</li>
                    </fieldset>
                  </div>
                </div>
                ...
                <li class="list-group-item">Declaration: {{ $application->DECLARATION_TITLE }}</li>
