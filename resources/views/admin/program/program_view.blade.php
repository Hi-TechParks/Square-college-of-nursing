          ...
          <main class="col-md-9">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <h6 class="card-title">{{ $program->TYPE_NAME }}</h6>
                <p class="card-text">{!! $program->PROGRAM_DESC !!}</p>
              </div>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Program Period: {{ $program->PROGRAM_PERIOD }}</li>
                <li class="list-group-item">Period Unit: {{ $program->PERIOD_UNIT }}</li>
