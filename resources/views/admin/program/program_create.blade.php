              ...
              <div class="card-body">
                ...
                <form action="{{url('/admin/program/store')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="category_name">
                        ...
                        <option value="{{ $program_cate->PROGRAM_TYPE_ID }}">{{ $program_cate->TYPE_NAME }}</option>
                        @endforeach
                      </select>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="number" class="form-control" name="period" placeholder="Program Period">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="number" class="form-control" name="period_unit" placeholder="Period Unit">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <textarea class="form-control" name="content" placeholder="Description" rows="15"></textarea>
