        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <a href="{{ url('/admin/slide/edit/'.$slide->SLIDE_IMAGE_ID) }}" class="btn btn-primary">Refresh</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                <!--== Data Form Start ==-->
                <form action="{{ url('/admin/slide/update/'.$slide->SLIDE_IMAGE_ID) }}" method="post" enctype="multipart/form-data">
                  @csrf
