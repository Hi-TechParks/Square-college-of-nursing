        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <a href="{{ URL('/admin/member/create')}}" class="btn btn-primary">Refresh</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                <!--== Data Form Start ==-->
                <form action="{{url('/admin/member/store')}}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="academic_designation">
                        ...
                        <option value="{{ $aca_designation->DESIGNATION_ID }}">{{ $aca_designation->DESIGNATION_NAME }}</option>
                        @endforeach
                      </select>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="admin_designation">
                        ...
                        <option value="{{ $adm_designation->DESIGNATION_ID }}">{{ $adm_designation->DESIGNATION_NAME }}</option>
                        @endforeach
                      </select>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <textarea class="form-control" name="content" placeholder="Profile Content" rows="15"></textarea>
