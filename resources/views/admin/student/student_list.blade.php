        ...
        <div class="row">
          ...
          <main class="col-md-9">
            <div class="card">
              <div class="card-body">
                <!--== Search Form Start ==-->
                <form action="{{ url('/admin/student') }}" method="get" class="dashboard-search-form">
                  <div class="row">
                    <div class="col">
                  ...
                  <tr>
                    ...
                    <td>
                      @if( $application->ACTIVE_STATUS == '1' )
                        <a href="{{ url('/admin/student/status/'.$application->STUDENT_ID) }}" class="active_status">Active</a>
                      @else
                        <a href="{{ url('/admin/student/status/'.$application->STUDENT_ID) }}" class="inactive_status">Inactive</a>
                      @endif
                    </td>
                    <td>
                      <a href="{{ url('/admin/student/show/'.$application->STUDENT_ID) }}" class="btn btn-success">View</a>
